const ICONS = [
  {id:"time",name:"Time",category:"Time",tags:["clock","schedule","history"],description:"Minimal clock for time and recent activity.",
  ...
  {id:"search",name:"Search",category:"Navigation",tags:["find","discover"],description:"Clean search icon for discovery and navigation.",
  ...
  {id:"home",name:"Home",category:"Navigation",tags:["house","main"],description:"Simple home outline for primary navigation.",
  ...
  {id:"user",name:"User",category:"Users",tags:["account","profile"],description:"Neutral user icon for account and identity surfaces.",
  ...
  {id:"settings",name:"Settings",category:"System",tags:["gear","preferences"],description:"Minimal settings icon for configuration controls.",
  ...
  {id:"calendar",name:"Calendar",category:"Time",tags:["date","event"],description:"Compact calendar for dates and schedules.",
  ...
  {id:"history",name:"History",category:"Time",tags:["recent","activity"],description:"History arrow for recent actions and activity logs.",
  ...
  {id:"check",name:"Check",category:"Actions",tags:["done","success"],description:"Confirmation mark for actions and success states.",
  ...
  {id:"plus",name:"Plus",category:"Actions",tags:["add","create"],description:"Universal add action with balanced geometry.",
  ...
  {id:"edit",name:"Edit",category:"Actions",tags:["write","modify"],description:"Compact edit mark for content and settings.",
  ...
  {id:"trash",name:"Delete",category:"Actions",tags:["remove","trash"],description:"Restrained delete icon for destructive controls.",
  ...
  {id:"download",name:"Download",category:"Files",tags:["save","export"],description:"Download action for digital asset files.",
  ...
  {id:"upload",name:"Upload",category:"Files",tags:["import","upload"],description:"Upload action for bringing files into a project.",
  ...
  {id:"file",name:"File",category:"Files",tags:["document","page"],description:"Minimal document symbol for file interfaces.",
  ...
  {id:"folder",name:"Folder",category:"Files",tags:["directory","collection"],description:"Folder outline for file groups and collections.",
  ...
  {id:"heart",name:"Favorite",category:"Users",tags:["like","saved"],description:"Simple favorite control for saved assets.",
  ...
  {id:"lock",name:"Lock",category:"Security",tags:["private","password"],description:"Security icon for protected account surfaces.",
  ...
  {id:"eye",name:"Preview",category:"Actions",tags:["view","inspect"],description:"Preview control for inspecting assets before use.",
  ...
  {id:"mail",name:"Mail",category:"Communication",tags:["email","message"],description:"Minimal email icon for communication surfaces.",
  ...
  {id:"bell",name:"Notification",category:"Communication",tags:["alert","notify"],description:"Notification bell for alerts and updates.",
  ...
  {id:"shield",name:"Shield",category:"Security",tags:["protect","safe"],description:"Security shield for privacy and protection concepts.",
